"use strict";(self.webpackChunkstrapi_pen=self.webpackChunkstrapi_pen||[]).push([[8477],{8477:(b,O,t)=>{t.r(O),t.d(O,{default:()=>U});var a=t(92132),c=t(21272),h=t(33544),s=t.n(h),m=t(52993),v=t(7153),C=t(83997),f=t(8361),A=t(16918),R=t(10229),y=t(68802),T=t(55506),B=t(54894),I=t(63891);const L=n=>{const{selectProps:d}=n,i=p=>o=>{o.preventDefault(),d.onChange(d.value.filter(_=>_!==p))};return(0,a.jsx)(m.v,{type:"button",tabIndex:-1,icon:(0,a.jsx)(y.A,{}),onClick:i(n.data),children:n.data.label})},K=(0,I.default)(T._8)`
  .select-control {
    height: auto;
